			...
			<div className='flex'>
				<header className='fixed z-[20] w-full px-10 bg-white bg-opacity-90 shadow-lg'>
					<div className='md:container md:flex justify-between mx-auto'>
						<a rel='noopener noreferrer' href='/#' className='flex items-center py-2 font-bold text-2xl tracking-widest'>
						...
						<div className='flex-shrink-0 hidden md:flex flex-row items-center'>
							<button className='self-start md:self-center px-4 font-semibold mr-2 border-r-[1px]'>Sign in</button>
